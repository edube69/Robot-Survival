...
export const Audio = {
    ...
    playSoundEffect(type) {
        switch (type) {
            case 'shoot': {
                // Tir laser/projectile: sweep de fréquence avec filtrage
    ...
    playLootBoxCollectSound({
        ...
        // Son de collection �pique et satisfaisant
        const osc = this.context.createOscillator();
        const gain = this.context.createGain();
        ...
        // Accord majeur pour l'effet de r�compense
    ...
    playNukeExplosionSound({
        ...
        // Son d'explosion nucl�aire massif et dramatique
        const osc = this.context.createOscillator();
        const gain = this.context.createGain();
        const filter = this.context.createBiquadFilter();
    ...
    playGiantMagnetSound({
        ...
        // Son magn�tique avec effet de succion
        const osc = this.context.createOscillator();
        const gain = this.context.createGain();
        const filter = this.context.createBiquadFilter();
